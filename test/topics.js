...
describe('Topic\'s', () => {
	...
	describe('.reply', () => {
		...
		it('should be anonymous', async () => {
			const result = await topics.reply({ uid: topic.userId, content: 'hello this is anonymous', tid: newTopic.tid, toPid: newPost.pid, contentAnonymous: true });
			assert.ok(result);
		...
		it('should not be anonymous', async () => {
			const result = await topics.reply({ uid: topic.userId, content: 'hello this is not anonymous', tid: newTopic.tid, toPid: newPost.pid, contentAnonymous: false });
			assert.ok(result);
