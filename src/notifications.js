...
Notifications.merge = async function (notifications) {
  ...
  const mergeIds = ['notifications:upvoted-your-post-in', 'notifications:user-started-following-you', 'notifications:user-posted-to', 'notifications:user-flagged-post-in', 'notifications:user-flagged-user', 'new-chat', 'notifications:user-posted-in-public-room', 'new-register', 'post-queue'];
