...
module.exports = function (User) {
  ...
  User.bans.unban = async function (uids, reason = '') {
    ...
    for (const user of userData) {
      ...
      await Promise.all([db.sortedSetAdd(`uid:${user.uid}:unbans:timestamp`, now, unbanKey), db.setObject(unbanKey, unbanData), groups.leave(groups.BANNED_USERS, user.uid),
